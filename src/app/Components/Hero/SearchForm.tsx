...
function SearchForm({query} : {query? : string}){
    ...
    return(
        <Form id="searchForm" action="/" className="flex w-full gap-x-[10px] mt-[40px]">
            ...
            <div className="group w-full flex bg-white h-[40px] rounded-full pl-[15px] border-2 justify-center items-center">
                <input 
                    id="searchInput"
                    name="query"
                    type="text"
                    ...
                    className="w-full focus:border-[#291b5aaa] focus:outline-none tracking-wider"
                />
